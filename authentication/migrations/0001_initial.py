    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('staff', 'Staff'), ('vendor', 'Vendor'), ('agaseke', 'agaseke')], default='user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_method', models.CharField(choices=[('pickup', 'Pickup from agaseke'), ('delivery', 'Home Delivery')], default='pickup', max_length=20)),
                ...
                ('agaseke_commission_amount', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='purchases', to=settings.AUTH_USER_MODEL)),
                ('agaseke_user', models.ForeignKey(blank=True, help_text='agaseke user handling this purchase', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='agaseke_purchases', to=settings.AUTH_USER_MODEL)),
